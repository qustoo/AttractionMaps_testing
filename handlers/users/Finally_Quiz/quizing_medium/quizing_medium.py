...
from keyboards.inline.medium_keyboard import med_photo_keyboard1, medium_keyboard1, medium_keyboard2, medium_keyboard3, medium_keyboard4, medium_keyboard5, medium_keyboard6, \
    medium_keyboard7, medium_keyboard8, medium_keyboard9, medium_keyboard10, medium_keyboard11, medium_keyboard12, \
    medium_keyboard13, Right_answers_med
...
async def question_1(call: CallbackQuery, state: FSMContext, callback_data: dict):
    ...
    await call.message.edit_text(text= "<b>Вопрос 11:</b>\n" + Medium_Array_Questions[10], reply_markup=medium_keyboard11)
...
async def question_1(call: CallbackQuery, state: FSMContext, callback_data: dict):
    ...
    await call.message.edit_text(text= "<b>Вопрос 12:</b>\n" + Medium_Array_Questions[11], reply_markup=medium_keyboard12)
...
async def question_1(call: CallbackQuery, state: FSMContext, callback_data: dict):
    ...
    await call.message.edit_text(text= "<b>Вопрос 13:</b>\n" + Medium_Array_Questions[12], reply_markup=medium_keyboard13)
