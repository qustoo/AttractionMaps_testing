...
photo_quiz=['easy_question_1','easy_question_2','easy_question_3','easy_question_4','easy_question_5','easy_question_6','easy_question_7','easy_question_8','easy_question_9','easy_question_10']
...
async def question_1(call: CallbackQuery):
    await call.answer(cache_time=60)
    await call.message.edit_media(media=InputMediaPhoto(media=open(photo_db.get_one_file_name(name=photo_quiz[9]), 'rb')),reply_markup=None)
