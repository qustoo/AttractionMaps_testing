...
YesOrNoFinishKeyboard = ReplyKeyboardMarkup(keyboard=[
    [
...
quiz_photo1 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Перейти к фото 2 вопроса", callback_data=quiz_photo_callback.new(next="p1"))]])
quiz_photo2 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Перейти к фото 3 вопроса", callback_data=quiz_photo_callback.new(next="p2"))]])
quiz_photo3 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Перейти к фото 4 вопроса", callback_data=quiz_photo_callback.new(next="p3"))]])
quiz_photo4 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Перейти к фото 5 вопроса", callback_data=quiz_photo_callback.new(next="p4"))]])
quiz_photo5 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Перейти к фото 6 вопроса", callback_data=quiz_photo_callback.new(next="p5"))]])
quiz_photo6 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Перейти к фото 7 вопроса", callback_data=quiz_photo_callback.new(next="p6"))]])
quiz_photo7 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Перейти к фото 8 вопроса", callback_data=quiz_photo_callback.new(next="p7"))]])
quiz_photo8 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Перейти к фото 9 вопроса", callback_data=quiz_photo_callback.new(next="p8"))]])
quiz_photo9 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Перейти к фото 10 вопроса", callback_data=quiz_photo_callback.new(next="p9"))]])
