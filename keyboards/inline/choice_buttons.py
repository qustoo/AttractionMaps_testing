    ...
    [
        [
            InlineKeyboardButton
                (
                text="Карты метности:",
                callback_data=buy_callback.new(item_name="terrain_map", scale=5000)
            )
        ],
        [
            InlineKeyboardButton
                (
                text="Карты маршрута:",
                callback_data=buy_callback.new(item_name="route_map", scale=1000)
            )
        ],
        [
            InlineKeyboardButton
...
terrain_map_keyboard = InlineKeyboardButton(text="Купить тут!", url=TERRAIN_MAP_LINK)
...
route_map_link = InlineKeyboardButton(text="Купить тут!", url=ROUTE_MAP_LINK)
