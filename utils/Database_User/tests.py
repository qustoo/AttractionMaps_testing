...
def test():
    ...
    db.update_rating_easy(1, 10)
    db.update_rating_medium(1, 11)
    db.update_rating_hard(1, 12)
    db.update_lat(1, -10)
    db.update_lon(1, 10)
    print('RATING_EASY vasya = ',db.get_rating_easy(1))
    print('RATING_MEDIUM vasya = ', db.get_rating_medium(1))
    print('RATING_HARD vasya = ', db.get_rating_hard(1))
    users = db.select_all_users()
